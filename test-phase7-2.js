...
async function runTests() {
  ...
  // Try creating a task for invalid lead
  const t1 = await fetchJson('/tasks', {
      method: 'POST', headers, body: JSON.stringify({ title: 'Task 1', priority: 'LOW', leadId: '00000000-0000-0000-0000-000000000000' })
  });
  console.log('Task invalid lead:', t1.status, t1.data);

  // Try creating a note for invalid lead
  ...
  console.log('Note invalid lead:', n1.status, n1.data);
}
runTests();
